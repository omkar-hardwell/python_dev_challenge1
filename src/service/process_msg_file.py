...
Reference Link: https://github.com/mattgwwalker/msg-extractor
"""
import os
import sys
    ...
    def save(self, toJson=False, useFileName=False, raw=False):
        ...
        try:
            ...
            for attachment in self.attachments:
                ...
                '''attachment_abs_path = os.path.join(os.path.dirname(
                    os.path.abspath(__file__)),
                    format(dirName))
                attachmentPaths.append("/".join([
                    attachment_abs_path, attachment.save()]))'''
            ...
            if toJson:
                ...
                emailObj = {'from': self.sender,
                            'to': self.to,
                            'cc': self.cc,
                            'subject': self.subject,
                            'date': self.date,
                            'attachments': attachmentNames,
                            'attachments_path': dirName,
                            'body': self.body}
